...
using System;
namespace Soenneker.Coinbase.OpenApiClients.Cdp.V2.EmbeddedWalletApi.EndUsers.Item.Solana.Sign.Transaction
{
    /// <summary>
    /// Builds and executes requests for operations under \v2\embedded-wallet-api\end-users\{userId}\solana\sign\transaction
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class TransactionRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EmbeddedWalletApi.EndUsers.Item.Solana.Sign.Transaction.TransactionRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TransactionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/embedded-wallet-api/end-users/{userId}/solana/sign/transaction{?projectID*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EmbeddedWalletApi.EndUsers.Item.Solana.Sign.Transaction.TransactionRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TransactionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/embedded-wallet-api/end-users/{userId}/solana/sign/transaction{?projectID*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SignSolanaTransactionWithEndUserAccount200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SignSolanaTransactionWithEndUserAccount200Response?> PostAsync(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SignSolanaTransactionWithEndUserAccountRequest body, Action<RequestConfiguration<global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EmbeddedWalletApi.EndUsers.Item.Solana.Sign.Transaction.TransactionRequestBuilder.TransactionRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SignSolanaTransactionWithEndUserAccount200Response> PostAsync(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SignSolanaTransactionWithEndUserAccountRequest body, Action<RequestConfiguration<global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EmbeddedWalletApi.EndUsers.Item.Solana.Sign.Transaction.TransactionRequestBuilder.TransactionRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EmbeddedWalletApi.EndUsers.Item.Solana.Sign.Transaction.TransactionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EmbeddedWalletApi.EndUsers.Item.Solana.Sign.Transaction.TransactionRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EmbeddedWalletApi.EndUsers.Item.Solana.Sign.Transaction.TransactionRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Signs a transaction with the given end user Solana account.The unsigned transaction should be serialized into a byte array and then encoded as base64.**Transaction types**The following transaction types are supported:* [Legacy transactions](https://solana-labs.github.io/solana-web3.js/classes/Transaction.html)* [Versioned transactions](https://solana-labs.github.io/solana-web3.js/classes/VersionedTransaction.html)The developer is responsible for ensuring that the unsigned transaction is valid, as the API will not validate the transaction.
        /// </summary>
