...
#nullable restore
        ...
        public async Task<global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EndUsers.Item.Evm.EvmPostResponse> PostAsync(global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EndUsers.Item.Evm.EvmPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EndUsers.Item.Evm.EvmPostResponse>(requestInfo, global::Soenneker.Coinbase.OpenApiClients.Cdp.V2.EndUsers.Item.Evm.EvmPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Adds a new EVM EOA account to an existing end user. End users can have up to 10 EVM accounts.This API is intended to be used by the developer&apos;s own backend, and is authenticated using the developer&apos;s CDP API key.
        /// </summary>
