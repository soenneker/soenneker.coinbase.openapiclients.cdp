...
namespace Soenneker.Coinbase.OpenApiClients.Cdp.V2.EndUsers.Item.Solana
{
    ...
    public partial class SolanaRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccount201Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccount201Response?> PostAsync(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccountRequestRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccount201Response> PostAsync(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccountRequestRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccount201Response>(requestInfo, global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccount201Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Adds a new Solana account to an existing end user. End users can have up to 10 Solana accounts.This API is intended to be used by the developer&apos;s own backend, and is authenticated using the developer&apos;s CDP API key.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccountRequestRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.AddEndUserSolanaAccountRequestRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
