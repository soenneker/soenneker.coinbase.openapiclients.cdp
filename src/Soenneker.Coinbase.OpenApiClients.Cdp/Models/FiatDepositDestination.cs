...
namespace Soenneker.Coinbase.OpenApiClients.Cdp.Models
{
    ...
    public partial class FiatDepositDestination : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public string DepositDestinationId { get; set; }
#endif
        /// <summary>Fiat bank account details for a deposit destination. The `accountType` field indicates the account identification scheme and determines which fields are present.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.DepositDestinationFiat? Fiat { get; set; }
#nullable restore
#else
        public global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.DepositDestinationFiat Fiat { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestinationMetadata? Metadata { get; set; }
#nullable restore
#else
        public global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestinationMetadata Metadata { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatType? Type { get; set; }
        /// <summary>The timestamp when the deposit destination was last updated.</summary>
        public DateTimeOffset? UpdatedAt { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestination"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestination"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestination CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestination();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fiat", n => { Fiat = n.GetObjectValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.DepositDestinationFiat>(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.DepositDestinationFiat.CreateFromDiscriminatorValue); } },
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestinationMetadata>(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestinationMetadata.CreateFromDiscriminatorValue); } },
                ...
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.DepositDestinationFiat>("fiat", Fiat);
            writer.WriteObjectValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatDepositDestinationMetadata>("metadata", Metadata);
            ...
            writer.WriteEnumValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.FiatType>("type", Type);
