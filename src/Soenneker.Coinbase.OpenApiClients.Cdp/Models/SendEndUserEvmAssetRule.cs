...
namespace Soenneker.Coinbase.OpenApiClients.Cdp.Models
{
    ...
    public partial class SendEndUserEvmAssetRule : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Whether matching the rule will cause the request to be rejected or accepted.</summary>
        public global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule_action? Action { get; set; }
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>A schema for specifying criteria for the sendEndUserEvmAsset operation.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule.SendEndUserEvmAssetRule_criteria>? Criteria { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule.SendEndUserEvmAssetRule_criteria> Criteria { get; set; }
#endif
        ...
        public global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule_operation? Operation { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetEnumValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule_action>(); } },
                { "criteria", n => { Criteria = n.GetCollectionOfObjectValues<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule.SendEndUserEvmAssetRule_criteria>(global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule.SendEndUserEvmAssetRule_criteria.CreateFromDiscriminatorValue)?.AsList(); } },
                { "operation", n => { Operation = n.GetEnumValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule_operation>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule_action>("action", Action);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule.SendEndUserEvmAssetRule_criteria>("criteria", Criteria);
            writer.WriteEnumValue<global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule_operation>("operation", Operation);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SendEndUserEvmAssetRule_criteria : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule.SendEndUserEvmAssetRule_criteria"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule.SendEndUserEvmAssetRule_criteria CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Soenneker.Coinbase.OpenApiClients.Cdp.Models.SendEndUserEvmAssetRule.SendEndUserEvmAssetRule_criteria();
